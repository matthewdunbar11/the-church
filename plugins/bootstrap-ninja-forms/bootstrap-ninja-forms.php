...
class Ninja_Forms_Bootstrap_Classes {
  ...
  function enqueue_scripts() {
    wp_register_style( 'bootstrap_ninja_forms_styles', get_stylesheet_directory_uri() . '/plugins/bootstrap-ninja-forms/bootstrap-ninja-forms.css' );
    wp_register_script( 'bootstrap_ninja_forms_scripts', get_stylesheet_directory_uri() . '/plugins/bootstrap-ninja-forms/bootstrap-ninja-forms.js', array( 'jquery' ), false, true );
...
add_action( 'init', array( 'Ninja_Forms_Bootstrap_Classes', 'setup' ) );